...
const Navbar = (props: {
  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none 
      md:w-[425px] md:flex-grow-0 md:gap-1 xl:w-[465px] xl:gap-2">
        ...
        <div className="flex grab-5">
          ...
          <button
            className="rounded-xl px-4 py-2 text-sm font-bold transition duration-300 bg-white text-black hover:bg-gray-300 hover:text-black  hover:scale-105"
